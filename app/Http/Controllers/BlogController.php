...
class BlogController extends Controller
{
   ...
   { 
       ...
       return redirect()->route('blog.dashboard')->with(['message'=> 'Blog Created!']);
   }
   ...
   public function comment($id)
{
   ...
   public function update(Request $request, Blog $blog)
   {
       if ($blog->user_id == auth()->id()){
           ...
           return redirect()->route('blog.dashboard')->with(['message' => 'Blog Updated']);
       } else {
           abort(403);
       }
   ...
   public function delete(Blog $blog)
   {
       ...
       {
           $blog->delete();
           return redirect()->route('blog.dashboard')->with(['message' => 'Blog Deleted!']);
       } else {
           abort(403);
       }
